...
static esp_err_t index_handler(httpd_req_t *req){
 ...
 page += "<p align=center>";
 page += "<button style=background-color:yellow;width:200px;height:70px onmousedown=getsend('ledon')><b>BAT DEN</b></button>";
 page += "<button style=background-color:yellow;width:200px;height:70px onmousedown=getsend('ledoff')><b>TAT DEN</b></button>";
 page += "<button style=background-color:yellow;width:200px;height:70px onmousedown=getsend('autocar')><b>AUTO CAR</b></button>";
 page += "<button style=background-color:yellow;width:200px;height:70px onmousedown=getsend('manualcar')><b>MANUAL MODE</b></button>";
...
void startCameraServer(){
    ...
    httpd_uri_t manualmode_uri = {
        .uri       = "/manualcar",
        .method    = HTTP_GET,
        .handler   = manualmode_handler,
        .user_ctx  = NULL
    };
   ...
   httpd_uri_t stream_uri = {
    ...
    if (httpd_start(&camera_httpd, &config) == ESP_OK) {
        ...
        httpd_register_uri_handler(camera_httpd, &automode_uri);
        httpd_register_uri_handler(camera_httpd, &manualmode_uri);
    }
